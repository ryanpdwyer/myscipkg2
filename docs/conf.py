...
version = myscipkg2.__version__
# The full version, including alpha/beta/rc tags.
release = myscipkg2.__version__
...
htmlhelp_basename = 'myscipkg2doc'
...
latex_documents = [
  ('index', 'myscipkg2.tex', u'myscipkg2 Documentation',
   u'Ryan Dwyer', 'manual'),
]
...
man_pages = [
    ('index', 'myscipkg2', u'myscipkg2 Documentation',
     [u'Ryan Dwyer'], 1)
]
...
texinfo_documents = [
  ('index', 'myscipkg2', u'myscipkg2 Documentation',
   u'Ryan Dwyer', 'myscipkg2', 'One line description of project.',
   'Miscellaneous'),
]
